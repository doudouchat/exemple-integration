...
public class SwaggerIT extends AbstractTestNGSpringContextTests {
    ...
    public void schema() throws IOException {
        ...
        assertThat(schema.get(new SimpleKey("test_keyspace", TEST_APP, "v1", "account", "user")), is(notNullValue()));
        assertThat(schema.get(new SimpleKey("test_keyspace", TEST_APP, "v1", "account", "user")).getContent(),
