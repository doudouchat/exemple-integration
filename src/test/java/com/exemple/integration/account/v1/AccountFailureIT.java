...
public class AccountFailureIT extends AbstractTestNGSpringContextTests {
    ...
    @Test(dataProvider = "updatePatchFailures", dependsOnMethods = "com.exemple.integration.account.v1.AccountNominalIT.putSuccess")
    ...
    @Test(dependsOnMethods = "com.exemple.integration.account.v1.AccountNominalIT.putSuccess")
    ...
    @Test(dependsOnMethods = "com.exemple.integration.account.v1.AccountNominalIT.connexionSuccess")
    ...
    @Test(dataProvider = "updateFailure", dependsOnMethods = "com.exemple.integration.account.v1.AccountNominalIT.putSuccess")
